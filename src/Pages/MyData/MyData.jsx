...
const MyData = ({item}) => {
    const {image_url, service_name, service_area} = item;
    return (
        <tr className="hover:bg-gray-50 bg-[#C8F1F3] border-b transition duration-300">
                ...
                <td className="py-4 px-6 border-b">
                    ...
                    <button  className="ml-4 hover:bg-orange px-4 py-3 rounded-full bg-white cursor-pointer text-lg"><MdDelete /></button>
                </td>
            </tr>
    );
};
