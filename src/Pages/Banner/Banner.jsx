...
const Banner = () => {
    return (
        <div className="home-container flex gap-5 my-12">
            <div className="w-3/5">
                <p className="text-gray text-sm font-bold">Play. Explore . Learn</p>
                <h1 className="text-orange text-7xl font-bold my-7 leading-tight">A safe and joyful place for your lovely children</h1>
                <div className="flex gap-7 items-center">
                    <button className="button">Enroll Your kid</button>
                    <p className="text-xl font-bold flex items-center gap-2"><span className="p-3 rounded-full bg-orange"><FiPhoneCall/></span>+0980-99445</p>
                </div>
            </div>
